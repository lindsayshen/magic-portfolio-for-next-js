---
title: "Streamlining Portfolio Management for Front-Line Users"
publishedAt: "2024-06-06"  # Estimated based on Q1 2023 launch.  Adjust as needed.
summary: "Transformed an essential internal portfolio management tool, significantly boosting front-line user task efficiency via workflow optimization, superior data access, and more effective client management support."
images: ["/images/projects/north-star/JP_nologo_cover_2.png"]
...
{/* ORIGINAL (pre-anonymization, kept for personal notes): GLASS is an internal dashboard used by JPMorgan Chase sales teams to manage global client portfolios. As a mission-critical tool, it supports client engagement, cash flow analysis, and portfolio strategy across multiple markets. */}
SPARK is an internal dashboard used by Lumina Financial sales teams to manage global client portfolios. As a mission-critical tool, it supports client engagement, cash flow analysis, and portfolio strategy across multiple markets.
...
{/* ORIGINAL (pre-anonymization, kept for personal notes): Despite its importance, the legacy GLASS platform presented significant usability issues: */}
Despite its importance, the legacy SPARK platform presented significant usability issues:
...
{/* ORIGINAL (pre-anonymization, kept for personal notes): * **Tools:** Figma, LucidSpark, UserZoom, JPMC UIToolkit, Excel */}
* **Tools:** Figma, LucidSpark, UserZoom, Lumina UI Toolkit, Excel
...
***
{/* ORIGINAL (pre-anonymization, kept for personal notes): **1. User Interviews:** Conducted interviews with salespeople to gather initial insights into their workflows, pain points, and needs related to the GLASS platform. */}
**1. User Interviews:** Conducted interviews with salespeople to gather initial insights into their workflows, pain points, and needs related to the SPARK platform.
...
The final phase, Deliver, focused on bringing the design to life. Given the extensive work done in the previous phase to solidify requirements and validate design decisions, the team moved directly into implementation.
 <p>&nbsp;</p>
{/* ORIGINAL (pre-anonymization, kept for personal notes): * **Contribution to JPMC UIToolkit:** I contributed to the JPMC UIToolkit design system by providing new use cases for custom calendars. This included designing a flexible calendar component that allows users to view portfolio data and make comparisons across various timeframes, from preset options to custom date ranges, for both "Portfolio Over Time" and "Portfolio Insights" features. */}
* **Contribution to Lumina UI Toolkit:** I contributed to the Lumina UI Toolkit design system by providing new use cases for custom calendars. This included designing a flexible calendar component that allows users to view portfolio data and make comparisons across various timeframes, from preset options to custom date ranges, for both "Portfolio Over Time" and "Portfolio Insights" features.
   <p>&nbsp;</p>
...
{/* ORIGINAL (pre-anonymization, kept for personal notes): The redesigned GLASS dashboard features a modular, card-based layout, enabling salespeople to customize their view and focus on relevant information. Key features include: */}
The redesigned SPARK dashboard features a modular, card-based layout, enabling salespeople to customize their view and focus on relevant information. Key features include:
...
{/* ORIGINAL (pre-anonymization, kept for personal notes): * **System Integration:** Seamless integration with other JPMC systems. */}
* **System Integration:** Seamless integration with other LFC systems.
* **Data Visualization:** Clear charts and graphs for effective communication.
{/* ORIGINAL (pre-anonymization, kept for personal notes): * **Adherence to Standards:** While adhering to JPMC's design system, we optimized the interface for the specific needs of GLASS users, balancing familiarity with enhanced usability. */}
* **Adherence to Standards:** While adhering to LFC's design system, we optimized the interface for the specific needs of SPARK users, balancing familiarity with enhanced usability.


 <p>&nbsp;</p>
{/* ORIGINAL (pre-anonymization, kept for personal notes): ##### Current GLASS Sales Dashboard Experience */}
  ##### Current SPARK Sales Dashboard Experience
![image](/images/projects/jp-glass/curr_glass_exp.png)
 {/*  Replace with your actual image path */}

 <p>&nbsp;</p>
{/* ORIGINAL (pre-anonymization, kept for personal notes): ##### Future GLASS Sales Dashboard Experience */}
  ##### Future SPARK Sales Dashboard Experience
...
{/*## 6. Results & Impact*/}
## 📈 6. Results & Impact
{/* ORIGINAL (pre-anonymization, kept for personal notes): While the redesigned GLASS dashboard was initially slated for launch in Q1 2023, the rollout was delayed due to limited technical development resources. */}
While the redesigned SPARK dashboard was initially slated for launch in Q1 2023, the rollout was delayed due to limited technical development resources.
